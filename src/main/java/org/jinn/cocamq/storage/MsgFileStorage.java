...
public class MsgFileStorage implements MessageStorage{
	 ...
	 */
	@Override
	public void fetchMessagesBeforeByTopic(final WritableByteChannel socketChanel,final long offset,final long range, String topics) {
